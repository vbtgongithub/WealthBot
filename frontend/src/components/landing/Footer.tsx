...
export function Footer() {
  return (
    <footer className="bg-background-secondary border-t border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-text-muted leading-relaxed">
              AI-powered personal finance for Indian students. Predict, track, and control your spending.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-text-muted">
            &copy; {new Date().getFullYear()} WealthBot. All rights reserved.
          </p>
